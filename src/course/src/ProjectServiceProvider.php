...
namespace StarsNet\Project\Course;

use Illuminate\Support\ServiceProvider;

// Import the controller here directly
// use StarsNet\Project\Course\App\Http\Controllers\Customer\FakerController;
...
{
    protected $namespace = 'StarsNet\Project\Course\App\Http\Controllers';
