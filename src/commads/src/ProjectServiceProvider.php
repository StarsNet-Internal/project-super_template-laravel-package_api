...
namespace StarsNet\Project\Commads;

use Illuminate\Support\ServiceProvider;

// Import the controller here directly
// use StarsNet\Project\Commads\App\Http\Controllers\Customer\FakerController;
...
{
    protected $namespace = 'StarsNet\Project\Commads\App\Http\Controllers';

    protected $routePrefix = 'commads';
