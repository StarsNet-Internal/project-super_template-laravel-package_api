...
namespace StarsNet\Project\TuenSir;

use Illuminate\Support\ServiceProvider;

// Import the controller here directly
// use StarsNet\Project\TuenSir\App\Http\Controllers\Customer\FakerController;
...
{
    protected $namespace = 'StarsNet\Project\TuenSir\App\Http\Controllers';
