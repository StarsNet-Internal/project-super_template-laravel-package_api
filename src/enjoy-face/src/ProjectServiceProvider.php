...
namespace StarsNet\Project\EnjoyFace;

use Illuminate\Support\ServiceProvider;

// Import the controller here directly
// use StarsNet\Project\EnjoyFace\App\Http\Controllers\Customer\FakerController;
...
{
    protected $namespace = 'StarsNet\Project\EnjoyFace\App\Http\Controllers';

    protected $routePrefix = 'enjoy-face';
