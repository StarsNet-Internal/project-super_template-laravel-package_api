...
class CustomerGroupProductCategory extends Eloquent
{
    use ObjectIDTrait,
        StatusFieldTrait;
     ...
     * @var string
     */
    protected $collection = 'customer_group_product_categories';
    ...
    public function scopeByProductCategory(Builder $query, ProductCategory $category): Builder
    {
        return $query->where('product_category_id', $category->_id);
    }
    ...
    public function associateProductCategory(ProductCategory $category): bool
    {
        $this->productCategory()->associate($category);
        return $this->save();
    }

    public function dissociateProductCategory(): bool
    {
        $this->productCategory()->dissociate();
        return $this->save();
    }
