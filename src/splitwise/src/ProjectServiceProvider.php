...
namespace StarsNet\Project\Splitwise;

use Illuminate\Support\ServiceProvider;

// Import the controller here directly
// use StarsNet\Project\Splitwise\App\Http\Controllers\Customer\FakerController;
...
{
    protected $namespace = 'StarsNet\Project\Splitwise\App\Http\Controllers';

    protected $routePrefix = 'splitwise';
