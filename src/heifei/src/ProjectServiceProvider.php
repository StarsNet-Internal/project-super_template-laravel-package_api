...
namespace StarsNet\Project\HeiFei;

use Illuminate\Support\ServiceProvider;

// Import the controller here directly
// use StarsNet\Project\HeiFei\App\Http\Controllers\Customer\FakerController;
...
{
    protected $namespace = 'StarsNet\Project\HeiFei\App\Http\Controllers';

    protected $routePrefix = 'heifei';
